  ...
  <div class="card-body">
    ...
    <form class="my-auto" action="{{ route('member.store') }}" method="POST">
      ...
      <div class="mb-3">
        ...
        {{-- <x-input id="namaLengkap" name="namaLengkap" type="text" class="form w-100 p-0 pb-1 mb-3"  style="border: 0; border-bottom: 1px solid black;" placeholder="Masukkan Nama Lengkap" :value="old('namaLengkap')" required> --}}
        ...
        <div class="mb-3">
          ...
          {{-- <x-input id="tanggalLahir" name="tanggalLahir" type="text" class="form w-100 p-0 pb-1 mb-3"  style="border: 0; border-bottom: 1px solid black;" placeholder="Masukkan Tanggal Lahir" :value="old('tanggalLahir')" required> --}}
        ...
        <div class="mb-3">
          ...
          {{-- <x-input id="noTelp" name="noTelp" type="text" class="form w-100 p-0 pb-1 mb-3"  style="border: 0; border-bottom: 1px solid black;" placeholder="Masukkan No. Telepon" :value="old('noTelp')" required> --}}
        ...
        <div class="mb-3">
          ...
          {{-- <x-input id="email" name="email" type="email" class="form w-100 p-0 pb-1 mb-3"  style="border: 0; border-bottom: 1px solid black;" placeholder="Masukkan E-mail" :value="old('email')" required> --}}
